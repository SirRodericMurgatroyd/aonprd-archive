...
| [`1e/`](1e/README.md) | [aonprd.com](https://aonprd.com/) — Pathfinder 1e | in progress | server-rendered ASP.NET with no public JSON/elasticsearch API, so a breadth-first page crawl (search itself is server-side and not archivable) |
| [`legacy/`](legacy/README.md) | [legacy.aonprd.com](https://legacy.aonprd.com/) — the old Pathfinder Reference Document | in progress | pure static HTML site, mirrored by a breadth-first crawl (plus its cdn.paizo.com assets) |
