...
<head id="Head1">
    ...
    <title>
	Mythic Paths - Archives of Nethys: Pathfinder RPG Database
    ...
    <meta name="keywords" content="Archives, Nethys, Pathfinder, Official, PRD, PFSRD, Mythic, Paths" /><meta name="description" />
...
<body class="dark">
	<div id="wrapper" class="clearfix" >
		<form method="post" action="./MythicPaths.aspx" id="Form1">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>

<div class="aspNetHidden">

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="C5CACD2B" />
</div>
...
<div class="agreement-banner" id="agreement-banner">
    ...
    <h1 style="text-align: center"><a href="MythicPaths.aspx?Path=Archmage">Archmage</a> | 
                                   <a href="MythicPaths.aspx?Path=Champion">Champion</a> | 
                                   <a href="MythicPaths.aspx?Path=Guardian">Guardian</a> | 
                                   <a href="MythicPaths.aspx?Path=Hierophant">Hierophant</a> | 
                                   <a href="MythicPaths.aspx?Path=Marshal">Marshal</a> | 
                                   <a href="MythicPaths.aspx?Path=Trickster">Trickster</a></h1><hr />
    <h2 style="text-align: center"><span id="MainContent_SubLabel"><a href="PathAbilities.aspx?Path=Godling">Godling Path Abilities</a> | <a href="PathAbilities.aspx?Path=Universal">Universal Path Abilities</a><hr /></span></h2>
