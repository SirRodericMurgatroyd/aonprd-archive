...
<head id="Head1">
    ...
    <title>
	Tools - Archives of Nethys: Pathfinder RPG Database
    ...
    <meta name="keywords" content="Archives, Nethys, Pathfinder, Official, PRD, PFSRD, Tools" /><meta name="description" />
...
<body class="dark">
	<div id="wrapper" class="clearfix" >
		<form method="post" action="./Tools.aspx" id="Form1">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKMTkxMzA4MDk5NmRk5kFP0gDygQ5XvyZhiVdTT0ZxSOqEKKg77jvb3ixCjw0=" />
</div>

<div class="aspNetHidden">

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="01DFC430" />
</div>
