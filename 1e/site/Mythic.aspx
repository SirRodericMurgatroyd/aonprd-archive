...
<head id="Head1">
    ...
    <title>
	Mythic Index - Archives of Nethys: Pathfinder RPG Database
    ...
    <meta name="keywords" content="Archives, Nethys, Pathfinder, Official, PRD, PFSRD, Mythic" /><meta name="description" />
...
<body class="dark">
	<div id="wrapper" class="clearfix" >
		<form method="post" action="./Mythic.aspx" id="Form1">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKMTU5NjE0MzM0OGRk3tbx+H1OxxS3QZXYBbYRmQctDdQD0py47tkxsr6QeSk=" />
</div>

<div class="aspNetHidden">

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="E253D9A9" />
</div>
...
<div class="agreement-banner" id="agreement-banner">
    ...
    <h1 style="text-align: center"><a href="MythicPaths.aspx">Mythic Paths</a> | 
                                   <a href="Feats.aspx?Category=Mythic">Mythic Feats</a> | 
                                   <a href="MythicMonsters.aspx">Mythic Monsters</a> | 
                                   <a href="Spells.aspx?Class=Mythic">Mythic Spells</a></h1><hr />
    <h2 style="text-align: center"><span id="MainContent_SubLabel"></span></h2>
