...
<head id="Head1">
    ...
    <title>
	Master Summon List - Archives of Nethys: Pathfinder RPG Database
    ...
    <meta name="keywords" content="Archives, Nethys, Pathfinder, Official, PRD, PFSRD, Summon Monster" /><meta name="description" />
...
<body class="dark">
	<div id="wrapper" class="clearfix" >
		<form method="post" action="./MasterSummonList.aspx" id="Form1">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKLTcyNjIxNjkzNg9kFgJmD2QWAgIDD2QWAgIBD2QWBgIBDxYCHgdWaXNpYmxlaGQCBw88KwAJAQAPFgQeCERhdGFLZXlzFgAeC18hSXRlbUNvdW50AgFkFgJmD2QWAgIBDw8WAh4EVGV4dGVkZAIJDw9kPCsABgEAEBYBZhYBFgIeDlBhcmFtZXRlclZhbHVlZBYBAgRkZMbCDxkFNWAiavUiItKYye5xTePHFNW8BhMDqCiAnX3L" />
</div>

<div class="aspNetHidden">

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="B3461B26" />
</div>
...
<div class="agreement-banner" id="agreement-banner">
    ...
    <h1 class="title">The Master Summon List</h1>
    This list is intended to serve characters with the ability to summon creatures using the various summon spells available. Click the option you'd like to see below.<br />
    Some of the methods that add more summons may have additional requirements/criteria - always reference the originating source for full details (the sub-headers will contain a hyperlink, if an appropriate location in the Archives exists).
    <br /><br />
    <b><a href="MasterSummonList.aspx?SummonType=monster">Summon Monster</a></b><br />
    <b><a href="MasterSummonList.aspx?SummonType=nature">Summon Nature's Ally</a></b><br />
    
    <hr />
    <span id="MainContent_primaryHeader"></span>
    <span id="MainContent_referenceKey"></span>

    <table id="MainContent_DataListSummon" cellspacing="0" style="border-collapse:collapse;">
	<tr>
		<td>
            <span id="MainContent_DataListSummon_LabelName_0"></span>
        </td>
	</tr>
</table>
