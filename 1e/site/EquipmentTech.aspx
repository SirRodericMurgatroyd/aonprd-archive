...
<head id="Head1">
    ...
    <title>
	Technology - Archives of Nethys: Pathfinder RPG Database
...
<body class="dark">
	<div id="wrapper" class="clearfix" >
		<form method="post" action="./EquipmentTech.aspx" id="Form1">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKMTkxMzA4MDk5NmRkgNoQKiiqxruON00Tu/Rs0D/bmdCZ0c6O5BOK2mcNLyA=" />
</div>

<div class="aspNetHidden">

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="FF15B16C" />
</div>
