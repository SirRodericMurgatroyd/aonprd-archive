...
<head id="Head1">
    ...
    <title>
	Sources - Archives of Nethys: Pathfinder RPG Database
    ...
    <meta name="keywords" content="Archives, Nethys, Wiki, Archives of Nethys, Pathfinder, Official, AoN, AoNPRD, PRD, PFSRD, Source, Book" />
...
<body class="dark">
	<div id="wrapper" class="clearfix" >
		<form method="post" action="./Sources.aspx" id="Form1">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>

<div class="aspNetHidden">

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="4C0E1C06" />
</div>
...
<div class="agreement-banner" id="agreement-banner">
    ...
    <b>Note</b>: Selecting a specific Source shows all the items pulled from that source. Doing this requires checking all the various tables in the database, and may take a few minutes. Please be patient.<br /><br />
    <div>
