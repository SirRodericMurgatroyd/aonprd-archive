...
<head id="Head1">
    ...
    <meta name="keywords" content="Archives, Nethys, Wiki, Archives of Nethys, Pathfinder, Official, AoN, AoNPRD, PRD, PFSRD, Race, Aasimar, Adaro, Android, Aphorite, Aquatic Elf, Astomoi, Being of Ib, Boggard, Caligni, Catfolk, Cecaelia, Changeling, Deep One Hybrid, Dhampir, Drow, Drow Noble, Duergar, Duskwalker, Dwarf, Elf, Fetchling, Ganzi, Gathlain, Ghoran, Gillman, Gnome, Goblin, Green Martian, Grindylow, Grippli, Half-Elf, Halfling, Half-Orc, Hobgoblin, Human, Ifrit, Kasatha, Kitsune, Kobold, Kuru, Lashunta, Locathah, Merfolk, Monkey Goblin, Munavri, Nagaji, Naiad, Orang-Pendak, Orc, Oread, Primitive Human, Ratfolk, Reborn Samsaran, Reptoid, Rougarou, Sahuagin, Samsaran, Shabti, Skinwalker, Strix, Suli, Svirfneblin, Sylph, Syrinx, Tengu, Tiefling, Triaxian, Triton, Trox, Undine, Vanara, Vine Leshy, Vishkanya, Wayang, Wyrwood, Wyvaran, Yaddithian" /><meta name="description" />
...
<body class="dark">
	<div id="wrapper" class="clearfix" >
		<form method="post" action="./Races.aspx" id="Form1">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTE2NzM1MjA5NTUPZBYCZg9kFgICAw9kFgICAQ9kFgYCAQ8PFgIeBFRleHRlZGQCAw88KwAJAQAPFgQeCERhdGFLZXlzFgAeC18hSXRlbUNvdW50ZmRkAgUPD2Q8KwAGAQAQFgFmFgEWAh4OUGFyYW1ldGVyVmFsdWVkFgECBGRkHplb/UeJcIYvEGpzW/DT8O6jmRK9otr+ZZcQKJeSlZ0=" />
</div>
...
<div class="agreement-banner" id="agreement-banner">
    ...
    <h2 style="text-align: center"><a href="Races.aspx?Category=Core">Core Races</a> | 
                               <a href="Races.aspx?Category=NonCore">Other Races</a></h2><hr />

    <span id="MainContent_CategoryLabel"></span>
