...
<head id="Head1">
    ...
    <title>
	Random Treasure Generator - Archives of Nethys: Pathfinder RPG Database
    ...
    <meta name="keywords" content="Archives, Nethys, Pathfinder, Official, PRD, PFSRD, Random, Treasure, Generator" /><meta name="description" />
...
<body class="dark">
	<div id="wrapper" class="clearfix" >
		<form method="post" action="./RandomItemGenerator.aspx" id="Form1">
<div class="aspNetHidden">
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__LASTFOCUS" id="__LASTFOCUS" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJODkyMzA1OTU4D2QWAmYPZBYCAgMPZBYCAgEPZBYEAgEPEGRkFgFmZAIDD2QWBGYPZBYCAgEPEGRkFgFmZAIBD2QWCgIBDxBkZBYBZmQCAw8QZGQWAWZkAgUPEGRkFgFmZAIHDxBkZBYBZmQCCQ8QZGQWAGRkdmXSTIkDlmhf9P/b4XNFeCLACW+EGqbt7ibLtafF72Y=" />
</div>
...
<div class="aspNetHidden">
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="3A5306FA" />
</div>
...
<div class="agreement-banner" id="agreement-banner">
    ...
    Welcome to my little tool for generating random treasure. The tables behind this are based off of those found within <a href="http://paizo.com/products/btpy8tmc?Pathfinder-Roleplaying-Game-Ultimate-Equipment">Ultimate Equipment</a> and the <a href="http://paizo.com/pathfinderRPG/v5748btpy88yj">Core Rulebook</a>. While I do summarize some of the rules used there to generate the treasure, it is only a summary. I encourage you to read the Treasure Generator section of <a href="http://paizo.com/products/btpy8tmc?Pathfinder-Roleplaying-Game-Ultimate-Equipment">Ultimate Equipment</a> (page 360) if you wish to understand the process a bit more.
    <br />
    <select name="ctl00$MainContent$DropDownViewControl" onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;ctl00$MainContent$DropDownViewControl\&#39;,\&#39;\&#39;)&#39;, 0)" id="MainContent_DropDownViewControl">
	<option selected="selected" value="N/A">N/A</option>
	<option value="City Treasure">City Treasure</option>
	<option value="Encounter Treasure">Encounter Treasure</option>
	<option value="Kingdom Treasure">Kingdom Treasure</option>
	<option value="Treasure by Type">Treasure by Type</option>
	<option value="Treasure by Value">Treasure by Value</option>
