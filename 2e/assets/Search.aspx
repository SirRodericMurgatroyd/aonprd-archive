...
<head>
    ...
    <link href="/Styles/Layout.css?v=vj0TzNwFtn_l7QCKSFUn9Sfz7A34MJb2h4XoRu0jydg" rel="stylesheet" type="text/css" />
    <link href="/Styles/rpg-awesome.min.css" rel="stylesheet" type="text/css" />
    <link href="/Styles/Typography.css?v=3et3D84VeOgcsPaSRyGH6nF1FfjjYgVpcGBq4HyG5vg" rel="stylesheet" type="text/css" />
    <link href="/themes" rel="stylesheet" type="text/css" />
    <link href="/Styles/SitePrint.css?v=8wGbZVsBHNUZjW78tbaeVtZ_Jlm0ss-wjdlzy_jKlOY" rel="stylesheet" type="text/css" media="print" />
    ...
    <script type="text/javascript">
        window.elasticUrl = 'https://elasticsearch.aonprd.com/aon';
    </script>

        <script src="https://elasticsearch.aonprd.com/js/nethys-search-fe1a0039e858b223af94e3f92ca6287e6ad7f98d.js"></script>
        ...
        <div class="page clearfix" id="page">
            <div class="header">
                <div class="clear hideSkiplink" id="main-menu" >
                    ...
                    <div class="nav-parent" id="nav-parent">
                        ...
                        <a href="/Companions.aspx">Companions</a>
                        <a href="/Familiars.aspx">Familiars</a>
            ...
            <div class="main-wrapper" id="main-wrapper">
                ...
                <div class="main" id="main">
                    <div class="agreement-banner-wrapper hide-on-print">
                        <div class="agreement-banner" id="agreement-banner">
                            <a href="https://www.archivesofnethys.com/agreement.html"><u>Our Paizo partnership status has changed. Read our statement for more details</u></a>
                        </div>
                        <hr />
                    </div>
        ...
        <div class="modern-menu">
            ...
            <div class="modern-menu-items">
                ...
                <div class="modern-menu-subitems">
                    ...
                    <a class="modern-menu-item" href="/Companions.aspx">
                        <span class="modern-menu-item-icon"><i class="ra ra-wolf-head"></i></span>
                        <span class="modern-menu-item-text">Companions</span>
                    </a>
                    <a class="modern-menu-item" href="/Familiars.aspx">
                        <span class="modern-menu-item-icon"><i class="ra ra-raven"></i></span>
                        <span class="modern-menu-item-text">Familiars</span>
                    </a>
                </div>
                <div class="modern-menu-item">
                ...
                <div class="modern-menu-subitems">
                    ...
                    <a class="modern-menu-item" href="/Planes.aspx">
                        ...
                        <a class="modern-menu-item" href="/Setting.aspx?Group=40">
